...
#define __KERNEL_HEADERS__ "/prog/toolchains/arm-unknown-linux-uclibcgnueabi/arm-unknown-linux-uclibcgnueabi/sysroot/usr/include"
...
#define __UCLIBC_EXTRA_CFLAGS__ "-Os -s"
#undef __DODEBUG__
#undef __DOSTRIP__
#undef __DOASSERTS__
